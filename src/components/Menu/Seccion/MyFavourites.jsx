                            ...
                            <IconButton
                              onClick={() => {
                                if (
                                  ...
                                  console.log("mi userExists", userExists);
                                  ...
                                  console.log(
                                    "mi updatedReactionInfo (react info after)",
                                    updatedReactionInfo
                                  );
