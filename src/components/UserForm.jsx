                ...
                <Grid item xs={12} md={6} sx={{
                    ...
                    <Box sx={{ background: 'linear-gradient(to right, #f70776, #c3195d, #680747, #141010)', height: '100%' }}>
                        <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column', justifyContent: 'center', height: '100%' }}>
                            ...
                            <p style={{ color: '#FFFFFF', textAlign: 'center', fontSize: '.875em', fontFamily: '"Roboto", sans-serif' }}>Here you are will able to share your skills on the kitchen creating multiples Post about Recipies and advices !.</p>
                        </div>
                    </Box>
                </Grid>
            </Grid>
